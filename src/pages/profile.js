			...
			<div className="profileContainer">
				...
				<div className="contact">
					...
					<div className="contactRow">
						...
						<a target="_blank" href="https://segmentfault.com/u/shangxianqianxi">
							https://segmentfault.com/u/shangxianqianxi
						</a>
					</div>
					<div className="contactRow">
						<span>掘金：</span>
						<a target="_blank" href="https://juejin.im/user/5cc544fdf265da03867e5a14">
							https://juejin.im/user/5cc544fdf265da03867e5a14
						</a>
					</div>
					<div className="contactRow">
						<span>Github:</span>
						<a target="_blank" href="https://github.com/beforegolive">
